...
| **擦拭成功轨迹** | **≥1250（≥5 家族，含直擦）** | ✅ **2233 条 / 6 家族全部 ≥250**（共 2700，82.7%） |
...
- [x] 策略分类器在**原始 source 动作**上准确率显著高于随机（多样性验收）——
      抽屉 0.747 / 随机 0.200（3.7×），擦拭 0.996 / 随机 0.167（6.0×），
...
**2700 条 / 2233 成功（82.7%），六个家族全部 ≥250 条成功轨迹。**

| 家族 | 条数 | 成功 | 清除% | 力在区间% | 力N |
|---|---:|---:|---:|---:|---:|
| `tool_center` | 450 | 411 | 86.2 | 95.7 | 4.76 |
| `tool_offset` | 450 | 250 | 80.6 | 85.9 | 4.59 |
| `tool_tilt` | 450 | 386 | 83.4 | 91.7 | 4.66 |
| `tool_heavy_slow` | 450 | 405 | 75.3 | 94.3 | 5.18 |
| `tool_light_fast` | 450 | 400 | 87.7 | 96.2 | 4.56 |
| **`direct_wipe`** | 450 | **381** | 76.7 | 84.7 | 4.84 |

法向力 4.6~5.2 N（允许区间 3~8），工具滑脱 1.6~2.0 mm，擦拭阶段脱手 0.0~0.1%，
独立验收 14 项全通过。dirt 覆盖图见 `out/s3_wipe/dirt_tc.png`——
