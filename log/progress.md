...
| 项 | 目标 | 实际 |
|---|---|---|
| **抽屉成功轨迹** | **≥450（≥3 策略家族）** | ✅ **737 条 / 5 家族**（共 800，成功率 92.1%） |
| **旋钮成功轨迹** | **≥1000（≥4 策略家族）** | ✅ **1705 条 / 4 家族各 ≥297**（共 2400，71.0%；`rim_only` 480 条按设计失败，D-46） |
| **擦拭成功轨迹** | **≥1250（≥5 家族，含直擦）** | ✅ **2609 条 / 6 家族全部 ≥373**（共 2700，96.6%） |
...
- [x] 策略分类器在**原始 source 动作**上准确率显著高于随机（多样性验收）——
      抽屉 0.747 / 随机 0.200（3.7×），擦拭 0.985 / 随机 0.167（5.9×），
...
| 数据集 | 家族数 | 准确率 | 随机 | 提升 |
|---|---:|---:|---:|---:|
| 抽屉 | 5 | **0.747** | 0.200 | 3.7× |
| 擦拭 | 6 | **0.985** | 0.167 | 5.9× |
