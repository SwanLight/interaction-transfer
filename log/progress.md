...
| 旋钮成功轨迹 | ≥1000（≥4 策略家族） | ⬜ 未开始 |
| **擦拭成功轨迹** | **≥1250（≥5 家族，含直擦）** | ⬜ 未开始 |
...
- [ ] 策略分类器在**原始 source 动作**上准确率显著高于随机（多样性验收，待做）
...
1. **补齐五条未满足的原语格**，尤其 P7 rolling contact（现为 0 个物体）。
   方向是给推板加"跟随物体速度"的前馈，而不是继续调阻尼。
2. 擦拭 source（主任务，`plan/01` §0 的顺序里排在抽屉之后）
3. 旋钮 source
4. 多样性验收：策略分类器在原始 source 动作上的准确率
