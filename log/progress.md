...
**10 个物体、10740 条 episode、9046 条成功（84.2%）。**
...
**2400 条 / 1707 成功（71.1%）**，四个销钉家族分别 480 / 299 / 480 / 448 条成功，
...
| `pin_push_dual` | 299/480 | 100.0 | 0.0 | 0.0 | 96.6 | 2.4 | 36.4 |
...
压足 **19.5 N**（安全上限 25 N 之内）时只转到 **0.022 rad**，
