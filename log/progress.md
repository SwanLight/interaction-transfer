...
| 项 | 目标 | 实际 |
|---|---|---|
| **抽屉成功轨迹** | **≥450（≥3 策略家族）** | ✅ **752 条 / 5 家族**（共 800，成功率 94.0%） |
...
|---|---:|---:|---:|---:|---:|---:|
| `pinch_center` 中央夹持 | 160 | 135 | 150.6 | 6.1% | 92.6% | 73.0% |
| `pinch_offset` 偏置夹持 | 160 | 144 | 147.5 | 6.6% | 94.0% | 78.2% |
| `hook_both` 双指纯勾 | 160 | 156 | 141.8 | 12.5% | 99.9% | 100.0% |
...
`pitfalls.md` **P-30 ~ P-35**。其中 P-30 最重要，也推翻了 P-18 的既有做法：
