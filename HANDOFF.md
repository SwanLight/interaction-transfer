...
| **S5** | 🟨 **v2 契约 + 全量评估已跑** | `interaction-transfer-v2`（D-65/D-66 重做）；三任务全量 artifact + 九项闸门，结果见 `out/s5/README.md` |
...
|---|---:|---:|---:|---|---:|---|
| 抽屉 | 323 | 43 | 0.990 | ✅ 0.953 / 0.970 / 0.971 | **1.35%**（5.0/256 cell） | 0.968~0.989 |
| 擦拭 | 950 | 127 | 0.940 | ❌ 0.921 / **0.868** / 0.997 | 4.42%（9.6/256） | 0.973~0.981 |
| 旋钮 | 652 | 87 | 0.930 | ❌ **0.892** / **0.896** / 0.941 | 1.37%（4.4/256） | 0.966~0.978 |
