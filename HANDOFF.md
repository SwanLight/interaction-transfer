...
| 任务 | train | 1a′ conformal coverage | 2a width | 表面投影丢掉的力 |
|---|---:|---|---:|---:|
| 抽屉 | 323 | ✅ 0.953 / 0.970 / 0.971（τ*=0.990） | **1.35%**（5.0/256 cell） | **2.11%** |
| 擦拭 | 950 | ❌ 0.921 / 0.000\* / 0.868 / 0.997 | 4.42%（9.6/256） | 0.00% |
| 旋钮 | 652 | ❌ 0.892 / 0.896 / 0.941 | 1.37%（4.4/256） | 0.00% |

\* 擦拭那个 0.000 来自采集缺陷（D-69），**不得读成"两种实现不可互换"**。
